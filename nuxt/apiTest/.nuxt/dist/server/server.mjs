...
import { getCurrentInstance, reactive, toRef, isRef, inject, defineComponent, computed, ref, h, resolveComponent, effectScope, markRaw, toRaw, watch, isReactive, nextTick, unref, getCurrentScope, onScopeDispose, toRefs, version, shallowRef, Transition, Suspense, provide, mergeProps, withCtx, createVNode, useSSRContext, defineAsyncComponent, onErrorCaptured, createApp } from "vue";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/admin.b4e395fe.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/index.43fde9bc.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/login.d6ca645a.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/_id_.53f2d61e.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/index.e9065229.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/_userId_.be720841.js").then((m) => m.default || m)
  }
];
...
const namedMiddleware = {
  auth: () => import("./_nuxt/auth.9f012e7f.js")
};
...
const layouts = {
  default: () => import("./_nuxt/default.2f5b5a17.js").then((m) => m.default || m),
  plain: () => import("./_nuxt/plain.2a6fba9e.js").then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import("./_nuxt/error-component.1b66160b.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
